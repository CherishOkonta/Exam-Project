...
# Create User
sudo -i -u postgres psql -c "CREATE USER cherishokonta WITH ENCRYPTED PASSWORD 'cherishokonta'"
# Grant user privilege on database
sudo -i -u postgres psql -c "GRANT ALL PRIVILEGES ON DATABASE laravelApp to cherishokonta"
